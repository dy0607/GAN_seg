...
if __name__ == '__main__':
    ...
    parser.add_argument("--cfg", default="config/ade20k-hrnetv2.yaml", metavar="FILE", help="path to config file", type=str)
    parser.add_argument("--gpus", default="0-3", help="gpus to use, e.g. 0-3 or 0,1,2,3")
